...
public class GuilScrolledBox extends GuiElement {
    ...
    protected void overlayBackground(int start, int end, int color, int startColor, int endColor) {
        ...
        worldrenderer.pos(x0, end, 0.0D).tex(0.0D, end / f)
        .color(r, g, b, a).endVertex();        
        worldrenderer.pos(x1, end, 0.0D).tex(gui.width / f, end / f)   
        .color(r, g, b, a).endVertex();
        
        worldrenderer.pos(x1, start, 0.0D).tex(gui.width / f, start / f)
        .color(r, g, b, a).endVertex();       
        worldrenderer.pos(x0, start, 0.0D).tex(0.0D, start / f)
        .color(r, g, b, a).endVertex();
    ...
    protected void overlayShadow(int start, int end, int color, int startColor, int endColor) {
        ...
        worldrenderer.pos(x0, end, 0.0D).tex(0.0D, end / f)
        .color(r, g, b, startColor+1).endVertex();        
        worldrenderer.pos(x1, end, 0.0D).tex(gui.width / f, end / f) 
        .color(r, g, b, startColor+1).endVertex();
        
        worldrenderer.pos(x1, start, 0.0D).tex(gui.width / f, start / f)
        .color(r, g, b, endColor+1).endVertex();        
        worldrenderer.pos(x0, start, 0.0D).tex(0.0D, start / f)
        .color(r, g, b, endColor+1).endVertex();
    ...
    public static final ResourceLocation sandy = new ResourceLocation("textures/blocks/soul_sand.png");
    ...
    public void render() {
        ...
        //create_overlayBackground(y, h, 110, 255, 255);
        GL11.glPushMatrix();
        ...
        overlayShadow(y, y + 8, 0x000000, 0xff, 0x00);
        overlayShadow(h - 8, h, 0x000000, 0x00, 0xff);
