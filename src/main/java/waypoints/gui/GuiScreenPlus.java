...
public class GuiScreenPlus extends GuiContainer {
    ...
    @Override
    public void handleInput()/*TODO  */ throws IOException	    	
    {
    	if (Mouse.isCreated())//Not sure if this is needed
        {
        while (Mouse.next()) {
        	//or this
            ...
            //or this but it seemed to fix random crashes?
    ...
    @Override
    public void handleMouseInput()/* TODO */ throws IOException
    {
    ...
    @Override
    public void handleKeyboardInput()/* TODO  */throws IOException
    {
