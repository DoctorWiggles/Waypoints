...
import waypoints.network.Packets;
...
public class BlockWaypoint extends Block {
    ...
    //TODO double check - seems to work mostly
    @Override
    ...
    //TODO double check teleport collisions
